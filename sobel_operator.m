...
for i = 1:size(input_image, 1) - 2
    for j = 1:size(input_image, 2) - 2
        ...
        filtered_x_image(i+1,j+1) = Gx;
        filtered_y_image(i+1,j+1) = Gy;
...
filtered_x_image = uint8(filtered_x_image);
figure, imshow(filtered_x_image); title('Filtered x axis Image');

filtered_y_image = uint8(filtered_y_image);
figure, imshow(filtered_y_image); title('Filtered y axis Image');
