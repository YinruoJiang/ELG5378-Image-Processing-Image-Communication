...
def color_gradient_threshold(image_undistorted):
    ...
    c_binary = color_thresh(image_undistorted, s_thresh=(70, 100), l_thresh=(60, 255), b_thresh=(50, 255),
                            v_thresh=(150, 255))
...
left_fitx, right_fitx, left_line_pts, right_line_pts, window_img, out_img, left_lane_inds, right_lane_inds = sliding_window(
